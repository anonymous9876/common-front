...
public class ProductLineItemTableBean implements SupplierPortalTableBean {
	private SupplierPortalTableBean tableBean;
	private MessageSource messageSource;
	private Locale locale;

	public ProductLineItemTableBean(SupplierPortalTableBean tableBean, MessageSource messageSource, Locale locale) {
